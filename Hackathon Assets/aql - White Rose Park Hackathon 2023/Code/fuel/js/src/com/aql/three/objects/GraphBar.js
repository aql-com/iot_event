...
class GraphBar {
    ...
    fontLoaderLoadHandler(font) {
        ...
        this.percentageMesh.position.z = this.z;
    ...
    animateToPercentage(percentage) {
        ...
        gsap.to(this, {
            ...
            onUpdate: function () {
                ...
                self.width = ((self.maxWidth - self.minWidth) * (self.currentPercentage / 100)) + self.minWidth;
                self.update();
            }
        });
    }
    ...
    get percentageGeometry() {
        const geometry = new TextGeometry(`${Math.round(this.currentPercentage)}%`, {
            font: this.font,
            size: .07,
            height: .01
        });
