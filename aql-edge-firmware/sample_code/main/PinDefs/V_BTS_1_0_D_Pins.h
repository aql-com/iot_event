...
#ifndef V_BTS_1_0_D_PINS_H
#define V_BTS_1_0_D_PINS_H

#warning "USING BT SENSOR V1_0_D Pin definitions"
...
#define RXD1				(gpio_num_t)32	//16		// IN	GPI39  = J22 pin 2	BETTER IF WE USE 39! its IN only...
#endif

#ifdef METER_READING_2
#define METER_SENSOR			(gpio_num_t)33		// J10 pin 4		
#endif
...
#ifdef TANKSENSOR_1_ON_GPIO39
#define TANKSENSOR1			(gpio_num_t)32				// IN
#else
...
#define PORTB_USED
#define USM_ECHO			(gpio_num_t)32				// IN
...
#define RALLY_ALERT_BUTTON		(gpio_num_t)26				// IN
#define RALLY_CANCEL_BUTTON		(gpio_num_t)33	// 33				// IN

#define RALLY_TEST_BUTTON		(gpio_num_t)25 	// 25				// IN
#define RALLY_TEST_CANCEL_BUTTON	(gpio_num_t)26				// IN
#define RALLY_ALERT_CANCEL_BUTTON	(gpio_num_t)33	// 33				// IN
...
#define LORA_DIO2			(gpio_num_t)34				// IN
#endif
...
#define LED_POLARITY			NOT_INVERTED
#endif
