...
#warning "USING DEFAULT BUILD SETTINGS FROM default.h"

#define USING_PROJECT_SETTINGS

#define PROJECT_STRING			"Default"
...
#define SERVER_ADDRESS_AND_PORT_0		"tcp://iot-visualiser.com:8883"		// new mqtt server
#define SERVER_ADDRESS_AND_PORT_1		"tcp://lora.core.aql.com:1700"		// new lora server
#define SERVER_ADDRESS_AND_PORT_2		"tcp://iot-visualiser.com:8883"		// closed down Apr 2023
#define SERVER_ADDRESS_AND_PORT_3		"tcp://iot-visualiser.aql.com:3883"		// 

#define DFLT_SERVER_ADDRESS_AND_PORT	"tcp://iot-visualiser.com:8883"		// 

#define SERVER_SSL_MODE_0				1
#define SERVER_SSL_MODE_1				1
#define SERVER_SSL_MODE_2				1
#define SERVER_SSL_MODE_3				1
