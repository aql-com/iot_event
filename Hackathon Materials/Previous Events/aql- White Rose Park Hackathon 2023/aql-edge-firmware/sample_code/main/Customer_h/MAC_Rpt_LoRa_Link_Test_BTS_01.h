...
#ifndef LORA_LINK_TEST_01_H
#define LORA_LINK_TEST_01_H

#warning "USING DEFAULT BUILD SETTINGS FROM LoRa_Link_Test_BTS_01.h"

#define USING_PROJECT_SETTINGS

#define PROJECT_STRING			"LoRa_Link_Test_BTS_01"
