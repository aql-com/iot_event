//////////////////////////////////////////////
//
// MAC_Rpt - MAC_Rpt_UDP_Test_BTS_01.h
//
// aql Ltd
//
// Auth: DLT
...
#ifndef MAC_RPT_UDP_TEST_BTS_01_H
#define MAC_RPT_UDP_TEST_BTS_01_H

#warning "USING BUILD SETTINGS FROM MAC_Rpt_UDP_Test_01.h"

#define USING_PROJECT_SETTINGS

#define PROJECT_STRING			"MAC_Rpt_UDP_Test_BTS_01"
...
#define SERVER_ADDRESS_AND_PORT_0		"tcp://mqtt.prod.iot.ext.lb.aql.com:8883"	// main server:
//#define SERVER_ADDRESS_AND_PORT_1		"tcp://lora.core.aql.com:1700"			// new Lora UDP server:
#define SERVER_ADDRESS_AND_PORT_1		"tcp://109.239.102.45:1700"			// Lora UDP server:
...
//#define METER_READING
#define MR_RX_DATA_LEN			1024
#define METER_READ_TIME			10	// 60
#define METER_READ_DATA_TIMEOUT		5	// 10

#define MR_UART				UART_NUM_1

#define METER_READING_2
#define METER_READ_FRAME_TIME		 30 // 30 secs
