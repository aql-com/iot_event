...
const LOCATION_ID = "REPLACE_WITH_YOUR_LCOATON";
const DEVICE_ID = "REPLACE_WITH_YOUR_DEVICE";
const TOPIC = `location/${LOCATION_ID}/device/${DEVICE_ID}/event/up`;
const TEAM = "REPLACE_WITH_YOUT_TEAM_NAME"
const USER_NAME = "PROVIDED AT THE EVENT"
const PASSWORD  = "PROVIDED AT THE EVENT"
